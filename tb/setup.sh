...
# This requires: python 2.7+ with pip3 and virtualenv.
...
#	source env/bin/activate.sh
	...
	# https://packaging.python.org/guides/installing-using-pip3-and-virtual-environments/
