...
def run(
    ...
    ##
    cwd_start = os.getcwd()
    relative_output_path = os.path.relpath(cwd_start, test_location) # this is the output path relative to the test_location
...
@click.option("--dump", is_flag = True
    ,help = "Dump contents of valid test configuration.")
