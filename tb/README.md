...
understand the files and directories that get generated by `tb create`. These files are
fully detailed in the [Testbench Structure section](#testbench-structure).**
